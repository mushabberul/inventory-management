                            ...
                            <div class="col-sm-5">
                                ...
                                <ul class="dt-indicator">
                                    ...
                                    <li class="dt-indicator-item">
                                        ...
                                        <div class="dt-indicator-item__info" data-fill="52" data-max="100"
                                            data-percent="true">
                                    ...
                                    <li class="dt-indicator-item">
                                        ...
                                        <div class="dt-indicator-item__info" data-fill="18" data-max="100"
                                            data-percent="true">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-6 pr-2">
                                            ...
                                            <div class="dt-avatar-wrapper">
                                                ...
                                                <!-- Info -->
                                                <div class="dt-avatar-info dt-widget__title">
                                                    <span class="dt-avatar-name">Pukhraj
                                                        Prajapat</span>
                                                </div>
                                                <!-- /info -->
                                            </div>
            ...
            <div class="col-xl-3 col-md-6">
                ...
                <div class="dt-card dt-card__full-height bg-dark-primary text-white">
                    ...
                    <div class="dt-card__body text-center">
                        ...
                        <p class="card-text">Reffer us to your friends and earn bonus when they join.
                        </p>
                            ...
                            <div class="dt-card__body bg-gradient-dark-purple">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-8">
                                        ...
                                        <p class="mb-xl-0 display-5 font-weight-medium">Now, your
                                            account
                    ...
                    <div class="dt-card__body">
                        ...
                        <div class="media-list">
                            ...
                            <div class="media media-news">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <a class="d-inline-block ml-auto" href="javascript:void(0)"><span>Ready Full
                                                Story</span><i class="icon icon-long-arrow-right icon-lg ml-2"></i></a>
                                    </div>
                                </div>
                                <!-- /media body -->
                            ...
                            <div class="media media-news">
                                ...
                                <!-- Media Body -->
                                <div class="media-body">
                                    <h4 class="mb-2">Is cryptocurrency investment a trap or
                                        opportunity?
                                    </h4>
                                    <p>
                                        Cras tincidunt sit amet massa at accumsan. Mauris tincidunt
