            ...
            <div class="dropdown mb-6" id="user-menu-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{ route('logout') }}"
                        ...
                        <i class="icon
                        icon-edit icon-fw mr-2 mr-sm-1"></i>Logout
                    </a>
        ...
        <ul class="dt-side-nav">
            ...
            <li class="dt-side-nav__item open">
                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Dashboard">
                    <i class="icon icon-dashboard icon-fw icon-xl"></i> <span class="dt-side-nav__text">Dashboard</span>
                </a>
            ...
            <li class="dt-side-nav__item">
                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Editors">
                    <i class="icon icon-editor icon-fw icon-xl"></i> <span class="dt-side-nav__text">Editors</span>
                </a>
            ...
            <li class="dt-side-nav__item">
                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Pickers">
                    <i class="icon icon-picker icon-fw icon-xl"></i> <span class="dt-side-nav__text">Pickers</span>
                </a>
            ...
            <li class="dt-side-nav__item">
                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Maps">
                    <i class="icon icon-extensions icon-fw icon-xl"></i> <span class="dt-side-nav__text">Maps</span>
                </a>
            ...
            <li class="dt-side-nav__item">
                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="User Auth">
                    <i class="icon icon-auth-screen icon-fw icon-xl"></i> <span class="dt-side-nav__text">User
                        Auth</span> </a>
            ...
            <li class="dt-side-nav__item">
                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="List Type">
                    <i class="icon icon-all-contacts icon-fw icon-xl"></i> <span class="dt-side-nav__text">List
                        Type</span> </a>
            ...
            <li class="dt-side-nav__item">
                <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Extra Pages">
                    <i class="icon icon-ellipse-h icon-fw icon-xl"></i> <span class="dt-side-nav__text">Extras</span>
                </a>
