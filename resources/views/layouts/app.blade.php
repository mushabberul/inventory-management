            ...
            <div class="dt-header__container">
                    ...
                    <span class="dt-brand__logo">
                        <a class="dt-brand__logo-link" href="index-2.html">
                            <img class="dt-brand__logo-img d-none d-lg-inline-block"
                                src="{{ asset('assets/images') }}/logo.png" alt="Wieldy">
                            <img class="dt-brand__logo-symbol d-lg-none"
                                src="{{ asset('assets/images') }}/logo-symbol.png" alt="Wieldy">
                        </a>
                    </span>
                    <!-- /brand logo -->
                ...
                <div class="dt-header__toolbar">
                    ...
                    <form class="search-box d-none d-lg-block">
                        <input class="form-control border-0" placeholder="Search in app..." value=""
                            type="search">
                                        ...
                                        <div class="h-auto">
                                            ...
                                            <a href="javascript:void(0)" class="media">
                                                ...
                                                <img class="dt-avatar mr-3"
                                                    src="{{ asset('assets/images') }}/user-avatar/stella-johnson.jpg"
                                                    alt="User">
                                                <!-- avatar -->
                                            ...
                                            <a href="javascript:void(0)" class="media">
                                                ...
                                                <!-- Avatar -->
                                                <img class="dt-avatar mr-3"
                                                    src="{{ asset('assets/images') }}/user-avatar/jeson-born.jpg"
                                                    alt="User">
                                                <!-- avatar -->
                                            ...
                                            <a href="javascript:void(0)" class="media">
                                                ...
                                                <!-- Avatar -->
                                                <img class="dt-avatar mr-3"
                                                    src="{{ asset('assets/images') }}/user-avatar/selena.jpg"
                                                    alt="User">
                                                <!-- avatar -->
                                            ...
                                            <a href="javascript:void(0)" class="media">
                                                ...
                                                <!-- Avatar -->
                                                <img class="dt-avatar mr-3"
                                                    src="{{ asset('assets/images') }}/user-avatar/alex-dolgove.jpg"
                                                    alt="User">
                                                <!-- avatar -->
                                    ...
                                    <div class="dropdown-menu-body ps-custom-scrollbar">
                                        ...
                                        <div class="h-auto">
                                            ...
                                            <a href="javascript:void(0)" class="media">
                                                ...
                                                <!-- Avatar -->
                                                <img class="dt-avatar mr-3"
                                                    src="{{ asset('assets/images') }}/user-avatar/mathew.jpg"
                                                    alt="User">
                                                <!-- avatar -->
                                                ...
                                                <span class="media-body text-truncate">
                                                    ...
                                                    <span class="message text-light-gray text-truncate">Okay.. I will
                                                        be waiting for your...</span>
                                                </span>
                                                <!-- /media body -->
                                            ...
                                            <a href="javascript:void(0)" class="media">
                                                ...
                                                <!-- Avatar -->
                                                <img class="dt-avatar mr-3"
                                                    src="{{ asset('assets/images') }}/user-avatar/steve-smith.jpg"
                                                    alt="User">
                                                <!-- avatar -->
                                            ...
                                            <a href="javascript:void(0)" class="media">
                                                ...
                                                <!-- Avatar -->
                                                <img class="dt-avatar mr-3"
                                                    src="{{ asset('assets/images') }}/user-avatar/domnic-brown.jpg"
                                                    alt="User">
                                                <!-- avatar -->
                            ...
                            <li class="dt-nav__item dropdown">
                                ...
                                <a href="#" class="dt-nav__link dropdown-toggle no-arrow dt-avatar-wrapper"
                                    ...
                                    <img class="dt-avatar size-40"
                                        src="{{ asset('assets/images') }}/user-avatar/domnic-harris.jpg"
                                        alt="Domnic Harris">
                                </a>
                                <!-- /dropdown link -->
            ...
            <aside id="main-sidebar" class="dt-sidebar">
                <div class="dt-sidebar__container">
                    ...
                    <ul class="dt-side-nav">
                        ...
                        <li class="dt-side-nav__item">
                            <a href="widget.html" class="dt-side-nav__link" title="Widgets"> <i
                                    class="icon icon-widgets icon-fw icon-xl"></i>
                                <span class="dt-side-nav__text">Widgets</span> </a>
                        </li>
                        <li class="dt-side-nav__item">
                            <a href="metrics.html" class="dt-side-nav__link" title="Metrics"> <i
                                    class="icon icon-apps icon-fw icon-xl"></i>
                                <span class="dt-side-nav__text">Metrics</span> </a>
                        </li>
                        <li class="dt-side-nav__item">
                            <a href="layouts.html" class="dt-side-nav__link" title="Layouts"> <i
                                    class="icon icon-card icon-fw icon-xl"></i>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="task-manager.html" class="dt-side-nav__link" title="Todo App"> <i
                                    class="icon icon-check-square-o icon-fw icon-xl"></i>
                                <span class="dt-side-nav__text">Todo App</span> </a>
                        </li>
                        <li class="dt-side-nav__item">
                            <a href="contact.html" class="dt-side-nav__link" title="Contacts App"> <i
                                    class="icon icon-contacts icon-fw icon-xl"></i>
                                <span class="dt-side-nav__text">Contacts App</span> </a>
                        </li>
                        <li class="dt-side-nav__item">
                            <a href="chat.html" class="dt-side-nav__link" title="Chat App"> <i
                                    class="icon icon-chat-bubble icon-fw icon-xl"></i>
                        ...
                        <!-- Menu Item -->
                        <li class="dt-side-nav__item">
                            <a href="page-profile.html" class="dt-side-nav__link" title="Profile"> <i
                                    class="icon icon-profile2 icon-fw icon-xl"></i>
                                <span class="dt-side-nav__text">Profile</span> </a>
                        </li>
                        <li class="dt-side-nav__item">
                            <a href="page-wall.html" class="dt-side-nav__link" title="Wall App"> <i
                                    class="icon icon-avatar icon-fw icon-xl"></i>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Tables">
                                <i class="icon icon-table icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">Tables</span> </a>
                        ...
                        <!-- Menu Item -->
                        <li class="dt-side-nav__item">
                            <a href="basic-form.html" class="dt-side-nav__link" title="Basic Form"> <i
                                    class="icon icon-feedback icon-fw icon-xl"></i>
                                <span class="dt-side-nav__text">Basic Form</span> </a>
                        </li>
                        <li class="dt-side-nav__item">
                            <a href="file-upload.html" class="dt-side-nav__link" title="File Upload"> <i
                                    class="icon icon-upload icon-fw icon-xl"></i>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                title="Editors">
                                <i class="icon icon-editor icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">Editors</span> </a>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                title="Pickers">
                                <i class="icon icon-picker icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">Pickers</span> </a>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="drag-drop.html" class="dt-side-nav__link" title="Drag & Drop"> <i
                                    class="icon icon-drag-and-drop icon-fw icon-xl"></i>
                                <span class="dt-side-nav__text">Drag &amp; Drop</span> </a>
                        </li>
                        <li class="dt-side-nav__item">
                            <a href="sweet-alert.html" class="dt-side-nav__link" title="Sweet Alerts"> <i
                                    class="icon icon-sweet-alert icon-fw icon-xl"></i>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="notification-alert.html" class="dt-side-nav__link" title="Notifications">
                                <i class="icon icon-notification icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">Notifications</span>
                            </a>
                        </li>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Maps">
                                <i class="icon icon-extensions icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">Maps</span> </a>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow" title="Charts">
                                <i class="icon icon-chart icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">Charts</span> </a>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                title="User Auth">
                                <i class="icon icon-auth-screen icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">User Auth</span> </a>
                            ...
                            <ul class="dt-side-nav__sub-menu">
                                ...
                                <li class="dt-side-nav__item">
                                    <a href="page-login-2.html" class="dt-side-nav__link" title="Sign In 2"
                                        target="_blank">
                                ...
                                <li class="dt-side-nav__item">
                                    <a href="page-signup-2.html" class="dt-side-nav__link" title="Sign Up 2 Page"
                                        target="_blank">
                                ...
                                <li class="dt-side-nav__item">
                                    <a href="page-reset-password.html" class="dt-side-nav__link"
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                title="List Type">
                                <i class="icon icon-all-contacts icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">List Type</span> </a>
                            ...
                            <ul class="dt-side-nav__sub-menu">
                                ...
                                <li class="dt-side-nav__item">
                                    <a href="strip-list.html" class="dt-side-nav__link"
                                        title="Plain List with Divider">
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                title="eCommerce">
                                <i class="icon icon-shopping-cart icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">eCommerce</span> </a>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                title="Extra Pages">
                                <i class="icon icon-error icon-fw icon-xl"></i> <span class="dt-side-nav__text">Extra
                                    Pages</span> </a>
                        ...
                        <li class="dt-side-nav__item">
                            <a href="javascript:void(0)" class="dt-side-nav__link dt-side-nav__arrow"
                                title="Extra Pages">
                                <i class="icon icon-ellipse-h icon-fw icon-xl"></i> <span
                                    class="dt-side-nav__text">Extras</span> </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            ...
                            <div class="dt-card dt-chart dt-card__full-height">
                                ...
                                <div class="dt-chart__body">
                                    <canvas class="rounded-xl" id="chart-active-users" height="96"
                        ...
                        <div class="col-xl-3 col-sm-6">
                            ...
                            <div class="dt-card dt-chart dt-card__full-height">
                                ...
                                <!-- Chart Body -->
                                <div class="dt-chart__body">
                                    <canvas class="rounded-xl" id="chart-extra-revenue" height="96"
                                        data-shadow="yes"></canvas>
                                </div>
                                <!-- /chart body -->
                        ...
                        <div class="col-xl-3 col-sm-6">
                            ...
                            <div class="dt-card dt-chart dt-card__full-height">
                                ...
                                <!-- Chart Body -->
                                <div class="dt-chart__body">
                                    <canvas class="rounded-xl" id="chart-orders" height="96"
                                        data-shadow="yes"></canvas>
                                </div>
                                <!-- /chart body -->
                        ...
                        <div class="col-xl-3 col-sm-6">
                            ...
                            <div class="dt-card dt-chart dt-card__full-height">
                                ...
                                <!-- Chart Body -->
                                <div class="dt-chart__body">
                                    <canvas class="rounded-xl" id="chart-traffic-raise" height="96"
                                        data-shadow="no" data-type="line"></canvas>
                                </div>
                                <!-- /chart body -->
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-sm-7 pr-sm-2 mb-6 mb-sm-0">
                                            <h2 class="display-2 font-weight-medium mb-3">
                                                $179,626
                                                <span class="d-inline-block f-14 text-success">64% <i
                                                        class="icon icon-menu-up"></i></span>
                                            </h2>
                                            ...
                                            <p class="card-text">
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="btn text-white bg-cyan">Withdraw</a>
                                            </p>
                                            ...
                                            <ul class="dt-indicator">
                                                <li class="dt-indicator-item">
                                                    <h5 class="dt-indicator-title f-12">BTC <span
                                                            class="d-inline-block border-left text-light-gray pl-2 ml-1">8.74</span>
                                                    </h5>
                                                    <div class="dt-indicator-item__info" data-fill="78"
                                                        data-max="100" data-percent="true">
                                                ...
                                                <li class="dt-indicator-item">
                                                    <h5 class="dt-indicator-title f-12">RPL <span
                                                            class="d-inline-block border-left text-light-gray pl-2 ml-1">1.23</span>
                                                    </h5>
                                                    <div class="dt-indicator-item__info" data-fill="52"
                                                        data-max="100" data-percent="true">
                                                ...
                                                <li class="dt-indicator-item">
                                                    <h5 class="dt-indicator-title f-12">LTE <span
                                                            class="d-inline-block border-left text-light-gray pl-2 ml-1">0.71</span>
                                                    </h5>
                                                    <div class="dt-indicator-item__info" data-fill="18"
                                                        data-max="100" data-percent="true">
                        ...
                        <div class="col-xl-5 col-md-12">
                            ...
                            <div class="dt-card dt-card__full-height">
                                ...
                                <div class="dt-card__header">
                                    ...
                                    <!-- Card Tools -->
                                    <div class="dt-card__tools">
                                        <a href="javascript:void(0)" class="dt-card__more"><i
                                                class="icon icon-add-circle mr-2"></i>Add New
                                            Account</a>
                                    </div>
                                    <!-- /card tools -->
                                                    ...
                                                    <div class="col-6 pr-2">
                                                        ...
                                                        <div class="dt-avatar-wrapper">
                                                            ...
                                                            <img class="dt-avatar size-30"
                                                                src="{{ asset('assets/images') }}/user-avatar/nikki.jpg"
                                                                alt="Mila Alba">
                                                            <!-- /avatar -->
                                                ...
                                                <div class="row no-gutters">
                                                    ...
                                                    <div class="col-6 pr-2">
                                                        ...
                                                        <div class="dt-avatar-wrapper">
                                                            <!-- Avatar -->
                                                            <img class="dt-avatar size-30"
                                                                src="{{ asset('assets/images') }}/user-avatar/garry-sobars.jpg"
                                                                alt="Pukhraj">
                                                            <!-- /avatar -->
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="dt-card dt-card__full-height bg-dark-primary text-white">
                                ...
                                <div class="dt-card__body text-center">
                                    ...
                                    <a class="btn btn-secondary text-white" href="javascript:void(0)">Invite
                                        Friends</a>
                                        ...
                                        <div class="dt-card__body bg-gradient-dark-purple">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-8">
                                                    ...
                                                    <p class="mb-xl-0 display-5 font-weight-medium">Now, your account
                                                        is on your fingers</p>
                                                </div>
                                                <!-- /grid item -->
                                                ...
                                                <div class="col-xl-4">
                                                    <a href="javascript:void(0)" class="d-inline-block mb-2">
                                                        <img src="{{ asset('assets/images') }}/dashboard/google-play-store.png"
                                                            alt="Play Store" class="img-fluid">
                                                    </a> <a href="javascript:void(0)" class="d-inline-block">
                                                        <img src="{{ asset('assets/images') }}/dashboard/apple-app-store.png"
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="dt-card">
                                        ...
                                        <div class="dt-card__header">
                                            ...
                                            <!-- Card Tools -->
                                            <div class="dt-card__tools">
                                                <a href="javascript:void(0)" class="dt-card__more">Detailed
                                                    History</a>
                                            </div>
                                            <!-- /card tools -->
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-uppercase text-center" scope="col">
                                                                Date</th>
                                                            <th class="text-uppercase text-right" scope="col">Fee
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                    ...
                                    <div class="media-list">
                                        ...
                                        <div class="media media-news">
                                            ...
                                            <img class="img-fluid rounded-xl"
                                                src="{{ asset('assets/images') }}/dashboard/bitcoin-cryptocurrency-trader.jpg"
                                                alt="Crypto Currency">
                                            <!-- /image -->

                                            <!-- Media Body -->
                                            <div class="media-body">
                                                <h4 class="mb-2">10 things you must know before trading in
                                                    cryptocurrency</h4>
                                                <p>
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    ...
                                                    <a class="d-inline-block ml-auto"
                                                        href="javascript:void(0)"><span>Ready Full Story</span><i
                                        ...
                                        <div class="media media-news">
                                            ...
                                            <!-- Image -->
                                            <img class="img-fluid rounded-xl"
                                                src="{{ asset('assets/images') }}/dashboard/bitcoin-in-the-mousetrap.jpg"
                                                alt="Crypto Currency">
                                            <!-- /image -->

                                            <!-- Media Body -->
                                            <div class="media-body">
                                                <h4 class="mb-2">Getting started with cryptocurrency - what is
                                                    blockchain</h4>
                                                <p>
                                                    Cras tincidunt sit amet massa at accumsan. Mauris tincidunt
                                                    tincidunt est, et pulvinar
                                        ...
                                        <div class="media media-news">
                                            ...
                                            <!-- Image -->
                                            <img class="img-fluid rounded-xl"
                                                src="{{ asset('assets/images') }}/dashboard/concept-of-blockchain.jpg"
                                                alt="Block Chain">
                                            <!-- /image -->

                                            <!-- Media Body -->
                                            <div class="media-body">
                                                <h4 class="mb-2">Is cryptocurrency investment a trap or opportunity?
                                                </h4>
                                                <p>
                                                    Cras tincidunt sit amet massa at accumsan. Mauris tincidunt
                                                    tincidunt est, et pulvinar
                        ...
                        <div class="dt-customizer__body-inner">
                            ...
                            <section id="theme-chooser">
                                ...
                                <div class="dt-customizer__btn-group btn-group btn-group-toggle btn-group mb-1"
                                    data-toggle="buttons">
                                    <label class="btn btn-outline-light"><input class="theme-option"
                                            type="radio" name="options" id="theme-option-lite"
                                            value="lite">Lite</label>
                                    <label class="btn btn-outline-light"><input class="theme-option"
                                            type="radio" name="options" id="theme-option-semidark"
                                            value="semidark">Semi Dark</label>
                                    <label class="btn btn-outline-light"><input class="theme-option"
                                            type="radio" name="options" id="theme-option-dark"
                            ...
                            <section>
                                ...
                                <ul class="dt-list">
                                    ...
                                    <li class="dt-list__item">
                                        <div class="choose-option">
                                            <a href="https://wieldy-html.g-axon.work/back-office-mini"
                                    ...
                                    <li class="dt-list__item">
                                        <div class="choose-option">
                                            <a href="https://wieldy-html.g-axon.work/horizontal-dark"
                                                target="_blank" class="choose-option__icon">
